...
import PersonOffIcon from '@material-ui/icons/PersonAddDisabled';
...
const Me = (props) =>
{
	...
	if (room.hideSelfView)
	{
		selfViewState = 'self view hidden';
		selfViewTip = intl.formatMessage({
			id             : 'device.selfView',
			defaultMessage : 'Show self view'
		});
	}
	else
	{
		selfViewState = 'Hide self view';
		selfViewTip = intl.formatMessage({
			id             : 'device.selfView',
			defaultMessage : 'Hide self view'
		});
	}
								...
								>
									<div>
										<Fab
											aria-label={intl.formatMessage({
												id             : 'device.startVideo',
												defaultMessage : 'Hide self video'
											})}
											style={{ ...controls.item.style }}
											className={classnames('fab')}
											color={room.hideSelfView ? 'secondary' : 'default'}
											size={controls.item.size}
								...
								>
									<div>
										<Fab
											...
											style={{ ...controls.item.style }}
											className={classnames('fab')}
											color={room.settingsOpen ? 'secondary' : 'default'}
											size={controls.item.size}
