...
import Counter from '../../components/react-count-down/CountDown';
...
class VideoView extends React.PureComponent
{
	...
	_setTracks(videoTrack)
	{
		...
		if (videoTrack)
		{
			...
			videoElement.oncanplay = () =>
				this.setState((prevState) => ({ prevState, videoCanPlay: true }));
	...
	{
		this.setState((prevState) => ({ ...prevState, videoWidth: null, videoHeight: null }));
	}
