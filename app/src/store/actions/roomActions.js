...
export const isValidMeeting =(valid) => ({ type: 'IS_VALID_MEETING', payload: { valid } });
export const isGuest = (guest) => ({ type: 'IS_GUEST', payload: { guest } });
export const isBefore = (before) => ({ type: 'IS_BEFORE', payload: { before } });
export const isAfter = (after) => ({ type: 'IS_AFTER', payload: { after } });